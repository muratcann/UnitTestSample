...
{
    public class ProductControllerTestWithSqlServerLocaDb : ProductControllerTest
    {
        public ProductControllerTestWithSqlServerLocaDb()
        {
            var sqlCon = @"Server=(localdb)\murat;Database=TestDB;Trusted_Connection=true; MultipleActiveResultSets=true";
