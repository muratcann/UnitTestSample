...
namespace UnitTestSample.Test
{
    public class ProductControllerTest
    {
        ...
        {
            Product product = products.First(q => q.Id == productId);
        ...
        public async void CreatePOST_ValidModelState_CreateMethodExecute()
        {
            ...
            _mockRepo.Setup(repo => repo.Create(It.IsAny<Product>())).Callback<Product>(q => newProduct = q);
        ...
        {
            var result = _controller.Edit(2, products.First(q => q.Id == productId));
        ...
        public void EditPOST_InValidModelState_ReturnView(int productId)
        {
            ...
            var result = _controller.Edit(productId, products.First(q => q.Id == productId));
        ...
        [Theory]
        [InlineData(1)]
        public async void Delete_ActionExecutes_ReturnProdcut(int productId)
        {
            var product = products.First(q => q.Id == productId);
        ...
        [Fact]
        public void ProductExists_IdInValid_ReturnFalse()
        {
            Product product = null;
        ...
        [Theory]
        [InlineData(1)]
        public void ProductExists_IdValid_ReturnTrue(int productId)
        {
            var product = products.First(q => q.Id == productId);

            _mockRepo.Setup(repo => repo.GetById(1)).ReturnsAsync(product);
